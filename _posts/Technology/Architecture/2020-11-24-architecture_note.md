...
5. 设计折衷。架构师必须具备商业思维，技术架构的最终目的是支撑业务。
    1. 能从 “业务需求” 反推 “技术目标”，而非单纯接收需求。
    1. 缺乏商业思维会导致架构过度设计或方向偏离，例如为追求技术先进性而选择昂贵方案，却忽略了业务的成本预算和短期盈利需求；
    2. 判断哪些技术投入能带来更高回报，哪些功能可以暂缓开发，避免资源浪费；
    3. 考虑方案是否能快速响应市场变化，是否能支撑用户规模的增长，从而降低技术决策对业务的潜在风险。
    5. 我：很多技术方案单从技术角度已经说不清楚优劣了，比如有三四个方面，A看重12，B看重34，怎么争论都意义不大，这个时候业务价值、发展趋势的判断往往可以给出很重要的参考

段张博：在现实中，这（设计折衷）往往是方案评审中最混乱的环节。我们拿出方案A、B、C，罗列各自的优缺点1、2、3、4。当取舍显而易见时，决策很快；但当方案势均力敌时，争论会变得异常激烈，最终往往降级为【老板的一锤定音】或【团队的声量】。为什么会这样？在评审会上，当我们说“方案A性能好”、“方案B成本低”、“方案C大厂在用”时，在用例子、属性和共识来思考。比如我们应该用微服务，因为大厂都在用。究竟是因为方案是好的，所以大厂才用它？还是因为大厂用它，所以它才是好的？**从本质出发，是最强的建构性思维工具**，在工程领域，这就是第一性原理。
1. 类比和归纳：电池贵，因为市场价如此。
2. 原理和本质：电池成本取决于化学材料，我们能否换更便宜的？

在架构中，这意味着我们必须放慢找答案的冲动，先定义问题本身：
- 真正的问题是什么？
- 核心约束是什么？
- 性能、成本、效率、安全中，那个不可妥协的第一位是什么？
