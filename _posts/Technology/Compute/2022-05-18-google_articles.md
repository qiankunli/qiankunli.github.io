...
PS： 从某个提案者的视角看，协商过程是两轮广播，第一轮广播从接受者获悉其它提案者的提案，按统一规则（提案号最大）统一意见，第二轮广播则是对这个意见进行确认。
