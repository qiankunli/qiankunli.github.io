...
[Volcano 监控设计解读](https://bbs.huaweicloud.com/blogs/detail/239635)

没有podgroup的pod 不会被调度：webhook的功能主要是校验，其中一个校验是拦截create pod请求，如果根据pod 找不到podgroup则拒绝，确保所有podgroup 创建之后再创建pod。
