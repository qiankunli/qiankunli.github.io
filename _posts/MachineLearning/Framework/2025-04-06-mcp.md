...
2. 工具太多怎么办？ PS： 有一种思路是建立到“工具图谱”。
    1.  [Agent时代上下文工程的6大技巧](https://mp.weixin.qq.com/s/LdAMqqn54rRReYXS4iuU0w)如果允许用户自定义配置工具，会有人塞上百个来历不明的工具到你构建的动作空间里。显而易见，模型会更容易选错行动，或者采取低效路径，就是工具越多的Agent，可能越笨。一般的做法就是动态加载/卸载工具，类似RAG一样，但Manus尝试过之后，都是血的教训
