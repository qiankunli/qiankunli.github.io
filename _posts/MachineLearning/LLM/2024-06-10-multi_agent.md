...
从技术层面来看Agent，有各种划分、概念、定义，从产品视角，追求是一以贯之的，只需要“一个”足够通用的Agent。
...
1. 模块化：独立的智能体使开发、测试和维护变得更容易；
2. 专业化：可以创建专注于特定领域的专家智能体，这有助于提高整个系统的性能。每个Agent可能有不同的工具类型可用，也可能有不同的记忆系统。
...
3. 智能体间的通信（Agents Communication）；从通信范式、通信结构和通信内容三个方面对智能体间的通信进行解析：
    ...
    2. 通信结构可分为四类：
        ...
        3. 中心化（Centralized）结构，由一个或一组智能体构成中心节点，其他智能体只与中心节点通信；
